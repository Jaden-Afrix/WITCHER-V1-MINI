...
export async function execute(m, { client, args }) {
  ...
  try {
    ...
    if (!data?.url) return client.sendMessage(m.chat, { text: '❌ Audio not found. Try a different title.' }, { quoted: m })
    ...
    client.sendMessage(m.chat, { text: '⚠️ An error occurred. Please try again later.' }, { quoted: m })
  }
}
